module Api
  class RepositoriesController < ApplicationController
    def index
      ...
      # Include quick_start_url and docker_setup_url in JSON response
      render json: @repositories.as_json(methods: [:quick_start_url, :docker_setup_url])
    rescue => e
    ...
    def show
      ...
      render json: @repository.as_json(methods: [:quick_start_url, :docker_setup_url])
