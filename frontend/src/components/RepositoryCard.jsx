...
const RepositoryCard = ({ repository, fullWidth = false }) => {
  ...
  if (fullWidth) {
    return (
      <div className="card-gradient rounded-2xl p-6 transform hover:scale-[1.02] transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/20 group relative">
        <div className="flex flex-col md:flex-row md:items-center gap-6">
          ...
          <div className="flex md:flex-col gap-3 md:min-w-[200px]">
            <a
              ...
              className="flex-1 md:flex-none text-center bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-accent-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap"
            >
              View Details →
            </a>
            {repository.has_docker && repository.quick_start_url && (
              <a
                ...
                className="flex-1 md:flex-none text-center bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 whitespace-nowrap"
  ...
  return (
    <div className="card-gradient rounded-2xl p-6 transform hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/20 group relative">
      {/* Header */}
